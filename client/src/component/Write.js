...
const Write = () => {
  ...
  const imageHandler = () => {
    ...
    input.addEventListener('change', async () => {
      ...
      try {
        const result = await axios.post('https://port-0-server-2rrqq2blmqlhn5j.sel5.cloudtype.app/img', formData);
...
const submit = (title, content) => {
  ...
  axios
    .post('https://port-0-server-2rrqq2blmqlhn5j.sel5.cloudtype.app/write', data)
    .then((res) => {
      console.log(res);
    })
    .catch((err) => {
